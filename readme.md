...
- [devtools-proxy](https://github.com/bayandin/devtools-proxy) - tool for creating simultaneous connections via DevTools Protocol. Fully compatible with Selenium and ChromeDriver
