...
- [Prerender Buddy](https://chromewebstore.google.com/detail/prerenderbuddy/nfcnbflceplmhoamoehcfojmgdmkjegi) - Analyze crawler-readability and AI visibility signals from the active tab.
